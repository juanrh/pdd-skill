...
_Note_: this skill is not related to PDD as described on https://promptdriven.ai, that refers to another concept. This skill is only concerned with PDD as implemented in the [Strands Agents PDD SOP](https://github.com/strands-agents/agent-sop/blob/main/agent-sops/pdd.sop.md).
